...
@section('content')
    ...
    <form id="vironeer-submited-form" action="{{ route('admin.teams.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="name" name="team_name" class="form-control form-control-lg" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">{{ __('Administrative Name') }} : <span class="red">*</span></label>
                    <input type="name" name="administrative_name" class="form-control form-control-lg" required>
                </div>
